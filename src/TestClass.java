...
public class TestClass {
    ...
    public void testEmployeeRole() throws IOException {
        ...
        boolean result;
        CustomerProduct oP1 = new CustomerProduct(customer1, "LPT-001", LocalDate.of(2023, 6, 1),false);
        CustomerProduct oP2 = new CustomerProduct(customer1, "LPT-001", LocalDate.of(2023, 6, 5),false);
        CustomerProduct oP3 = new CustomerProduct(customer2, "SPK-004", LocalDate.of(2023, 5, 11),false);
        CustomerProduct oP4 = new CustomerProduct(customer3, "SPK-004", LocalDate.of(2023, 5, 12),false);
